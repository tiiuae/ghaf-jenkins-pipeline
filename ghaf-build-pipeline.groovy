...
pipeline {
  ...
  stages {
    ...
    stage('SBOM') {
      steps {
        dir('ghaf') {
          sh 'nix run github:tiiuae/sbomnix/a1f0f88d719687acedd989899ecd7fafab42394c#sbomnix -- .#packages.x86_64-linux.nvidia-jetson-orin-agx-debug-from-x86_64 --csv result-sbom-jetson-orin-agx-debug.csv --cdx result-sbom-jetson-orin-agx-debug.cdx.json --spdx result-sbom-jetson-orin-agx-debug.spdx.json'
          sh 'nix run github:tiiuae/sbomnix/a1f0f88d719687acedd989899ecd7fafab42394c#sbomnix -- .#packages.x86_64-linux.nvidia-jetson-orin-nx-debug-from-x86_64 --csv result-sbom-jetson-orin-nx-debug.csv --cdx result-sbom-jetson-orin-nx-debug.cdx.json --spdx result-sbom-jetson-orin-nx-debug.json'
          sh 'nix run github:tiiuae/sbomnix/a1f0f88d719687acedd989899ecd7fafab42394c#sbomnix -- .#packages.x86_64-linux.generic-x86_64-debug  --csv result-sbom-generic-x86_64-debug.csv --cdx result-sbom-generic-x86_64-debugcdx.cdx.json --spdx result-sbom-generic-x86_64-debug.spdx.json'
          ...
          sh 'nix run github:tiiuae/sbomnix/a1f0f88d719687acedd989899ecd7fafab42394c#sbomnix -- .#packages.aarch64-linux.nvidia-jetson-orin-nx-debug  --csv result-sbom-aarch64-jetson-orin-nx-debug.csv --cdx result-sbom--aarch64-jetson-orin-nx-debug.cdx.json --spdx result-sbom-aarch64-jetson-orin-nx-debug.json'
          sh 'nix run github:tiiuae/sbomnix/a1f0f88d719687acedd989899ecd7fafab42394c#sbomnix -- .#packages.aarch64-linux.imx8qm-mek-debug   --csv result-sbom-aarch64-imx8qm-mek-debug.csv --cdx result-sbom-aarch64-imx8qm-mek-debug.cdx.json --spdx result-sbom-aarch64-imx8qm-mek-debug.spdx.json'
        }
      }
    }
